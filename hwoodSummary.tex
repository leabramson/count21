...
%			These commonalities emerge despite these CoCs sharing no volunteer survey teams. 
%			Professional teams were shared in tracts comprising $\sim$43\% of total counts, but, 
%			except for E.~Hollywood's unsheltered individuals---which become consistent with the 2020 
%			value---downward trends hold when those teams' contributions are removed.
	\label{fig:rawCounts}
\end{figure*}
...
\caption*{Quantities in parentheses denote 95\% uncertainties (binomial in the case of the categories). Uncertainties larger than estimates imply that only upper limits can be stated confidently. No unaccompanied minors or families were observed.}
\label{tbl:}
\end{table*}
