...
about a third of census tracts. Unsheltered living has probably declined quantitatively even if the 
average occupancy of dwellings has changed. Despite that fact, however, 28\% of tracts
saw at least a doubling in tents, supporting qualitative perceptions that the state of homelessness 
has worsened over the past year. Given COVID-related contractions in health, hygiene, and social 
services, these impressions are also likely to be accurate. Coordinated Entry System data will reveal 
whether homelessness has declined generally or if government initiatives instead reduced Greater Hollywood's 
unsheltered share of it.
...
{cancellation} of the official 2021 Count. All 40 US Census tracts in the LAHSA-recognized Hollywood 
and East Hollywood communities were surveyed, 39 on 25 February and one on 16 March 
(Figure \ref{fig:tcomp}). Nine tracts were counted by professional outreach teams during the %---comprising $\sim$43\% of identified individuals and dwellings---
day. The remainder were surveyed by car-based volunteer teams starting at 7:00 PM.

Volunteer teams were assigned two tracts in one of the communities. Each tract was surveyed by at least two 
teams, increasing the accuracy of the count. Tracts counted by professionals were assessed only once. No 
...
Seven tracts saw significant population increases; 14 saw declines. The tracts with the largest increase (1912.01;
...
makeshift dwellings (CVRTM) were additionally boosted by their mean occupancy weights 
...
{SPA4/CD13 weights} underpinning the latest official Hollywood and East Hollywood 
...
$\nh$ and $\ne$ people experiencing unsheltered homelessness, \resp\ (90\% CI). Modifying the weights
...
{SPA4-wide} values or using data from surveys of tent-dwellers in Hollywood has no significant effect.
%\footnote{Those inferences yield $912\pm68$ and $944\pm118$ people
%in Hollywood, and $539\pm59$ and $559\pm87$ in E.~Hollywood, \resp.} 
All estimates suggest at least an 89\% chance of a decline compared to the 2020 PIT count.
...
unweighted counts, however, those dwellings' {\it average} occupancies must have risen to 2.1 and 2.5 people 
from 1.5 and 1.7 people, \resp, to erase the decline. Such $\sim$45\% increases in the mean seem unlikely given 
...
%	\setlength{\itemsep}{-1ex}
	\item Comparisons of the count's 38 duplicate tract measurements suggest per-tract and per-category
...
%		PIT value.% in unsheltered homelessness.
	\item A 27 Feb.\ recount of tract 1912.01 in E.~Hollywood conducted for 
		\href{https://selahnch.org}{\selah} agrees with our PIT value.% in unsheltered homelessness.
\end{enumerate}
...
Finally, perhaps 80 car and van dwellers were occupying the 49 safe parking spots near the survey area 
and went uncounted this year. Adding these to our inference, the baseline chance of a decline from 2020 
falls from 98\% to 88\%. All of the above suggests that our results are quantitatively and qualitatively reliable.\\
...
(Project Roomkey) and stanch inflow into homelessness (eviction moratoria) may be responsible. 
...
\href{https://www.lamayor.org/ABridgeHome}{\it A Bridge Home} in Los Feliz---whose catchment area 
...
{\it Yet}, to say nothing of the implications of our results for conditions after the eviction moratoria
lapse, if there are fewer people on the street today, their quality of life has degraded markedly. 
...
(EBT, Medi-Cal), DMV (ID replacement), and DMH facilities. Physical limitations on client access at 
hospitals and clinics has also hindered caseworkers in managing successful discharges. These qualitative 
harms are reflected by a 25\% increase in 
\href{https://www.latimes.com/california/story/2021-01-07/the-powerful-synthetic-opioid-fentanyl-is-behind-rising-deaths-in-the-homeless-population}{overdose deaths}, and visually amplified by a doubling of tents in 
28\% of census tracts\footnote{Including 1907.00, Central Hollywood's commercial core.} 
while tent folding ordinances and City and State sanitation programs were simultaneously 
