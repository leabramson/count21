...
imply that only upper limits are available. ``Persons'' are TAY+Adults; no unaccompanied minors or families were observed.}
...
%		PIT value.% in unsheltered homelessness.
	\item Tract 1912.01 in East Hollywood is one of four tracts monitored by \selah\ since May 2020. That 
		group's 27 Feb.\ estimate agrees with our PIT value.% in unsheltered homelessness.
\end{enumerate}
