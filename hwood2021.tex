...
and $-201\pm76$ counts or people, \resp.\footnote{Incorporates uncertainties 
in inferring tract-level CVRTM counts from data provided by the LAHSA portal.}

The tracts with the largest year-on-year gain (1912.01, $+40$ people) and loss (1927.00, $-125$ people)
are both in East Hollywood. They contain Barnsdall Park and US 101, \resp. Tract 1927.00 is
perhaps entirely responsible for East Hollywood's total inferred population decline. If that tract
is excluded, we estimate $427\pm61$ unsheltered people vs.~2020's estimate of 407. Section \ref{sec:discussion} 
explores this phenomenon in more detail.
...
anywhere from 0 to 4 occupants, each.} While neither the full 2021 PIT area nor $w_{M}$ has been assessed,\footnote{
An estimate for $w_{M}=1.75\pm0.66$ was obtained from four makeshifts on 14 March but small sample
size precludes any further interpretation.} 
...
Principally, smaller scales tell different stories than the community level results. Six tracts saw at least a 
