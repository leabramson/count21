...
unsheltered homelessness has fallen by $11\%\pm9\%$ and $15\%\pm12\%$, \resp, in those communities
...
of dwellings is updated. However, 28\% of tracts saw at least a doubling of tents and makeshift structures.
This enhanced visual salience of unsheltered living may support perceptions that the state of homelessness 
worsened over the past year, which---given COVID-related disruptions to health, hygiene, 
and social support services---are also likely to be accurate. Coordinated Entry System data will reveal whether 
homelessness in general has declined or merely Greater Hollywood's unsheltered portion.
...
Tract 1927.00 is unique in many respects (Section \ref{sec:discussion}). Foremost among these is that its precipitous 
decline since 2020 can account for all of East Hollywood's total unsheltered population change. It is also the only 
tract assessed by a team that also surveyed tracts in Hollywood. If it is excluded, we infer $427\pm61$ unsheltered 
people in that community vs.\ 407 in 2020. Person and dwelling trends remain similar to those in 
Hollywood whether or not 1927.00 is examined (Figure \ref{fig:proVolComp}).
...
Whether adopting the above $w_{T}$ values or using the most recent SPA4-wide CVRTM weights, 
all cases imply at least a 93\% chance of decline compared to 2020.
...
are substantial. Only $w_{T}$ and $w_{M}$ can reasonably achieve it. These must rise to 2.2 and 
...
spans 0\% to over 4\%, with a mean near 1\%---40\% higher than 
...
\begin{figure}[t!]
	...
	\caption{{\it Top:} 0\% to over 4\% of each tract's total population is experiencing unsheltered
			homelessness in Greater Hollywood. The mean of $\sim$1\% is about 40\% higher than 
...
\begin{figure}[t]
	...
	doubled. 1907.oo lies in the heart of Central Hollywood, increasing the visual impact of this
			rise in dwellings, which was almost offset by a decline in rough sleepers.}
	\label{fig:1907}
\end{figure}
