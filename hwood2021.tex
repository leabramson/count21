...
\caption*{$^{\rm a}$Volunteer vs.~professional surveyor; $^{\rm b}$no.~teams deployed to 
...
Hollywood regardless of whether 1927.00 is examined (Figure \ref{fig:proVolComp}), however.
...
the above values are consistent with the 2020 estimate of $w_{T}=1.48\pm0.11$. Adopting either updated 
$w_{T}$ value or replacing all weights with the last SPA4-wide values all leads to at least a 
93\% chance of a decline in unsheltered populations compared to 2020.
...
decline in unsheltered people from 98\% to 92\%. 
...
However, while our PIT data show a decline in unsheltered living, it is only one of $\sim$10\%. As such,
their implications for unsheltered homelessness \href{https://www.latimes.com/california/story/2021-01-12/new-report-foresees-tens-of-thousands-losing-homes-by-2023}
...
Finally, the leasing of 120 new PATH permanent supportive housing (PSH) units may also have contributed. 
...
the same interval in 2019. A more rigorous analysis is needed to determine the extent to which those deaths contributed qualitatively
to the decline we infer, but, quantitatively, they must.
...
Vine to Highland to La Brea.}  Not only did dwellings double here, but it is one of four tracts wherein dwellings
...
increase the salience of unsheltered living even as the population as a whole remained unchanged.
...
and state sanitation programs (which further increase the visual impact of tent doubling in 28\% of tracts). 
...
The latter would make it difficult for updates to the average occupancy of informal dwellings 
to erase the community-scale declines we infer. 
...
facility and new permanent supportive housing units likely also contributed, as, unfortunately, may 
deaths. Data from the Coordinated Entry System will test these statements.

While community-level counts declined, however, 28\% of tracts saw at least a doubling in tents and 
makeshift structures since 2020. This phenomenon---amplified by suspension of LAMC 56.11 enforcement
and compounded by city and state sanitation program reductions---may have contributed to qualitative 
perceptions that the state of homelessness has worsened over the past year. Given COVID-related 
disruptions to health, hygiene, and social support services---these sentiments are also likely to be 
accurate. Especially in light of the coming lifting of the aforesaid eviction moratoria, much work
remains to ensure everyone has a home in Hollywood.
...
\begin{figure}[t!]
	\centering
	\includegraphics[width =\linewidth]{primerFront}
...
\toprule
Tract & Community & Counter & Adults & TAY & $C$ & $V$ & $R$ & $T$ & $M$ & {\bf Total} \\ \cmidrule{1-11}
...
\caption*{Estimates reflect PDF medians with 90\% CIs shown in parentheses.}
\label{tbl:allPop}
\end{table*}
