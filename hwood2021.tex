...
1714 of whom (78\%) were unsheltered. This figure corresponds to roughly 
...
\href{https://geomap.ffiec.gov/FFIECGeocMap/GeocodeMap1.aspx}{3.5\% of its total population}. In some 
...
\begin{figure*}[t]
	...
	\caption{Explain what the PDFs and CDFs are, what the colors mean. Maybe 
			remake these with bigger bins and the 2020 value instead of 
			the mode shown.}
