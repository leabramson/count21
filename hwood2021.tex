...
\date{\vspace{-1em}\today}                                           % Activate to display a given date or no date
...
adult unsheltered homelessness has fallen by $\dh$ and $\de$, \resp, in those communities
...
census tracts. The adult unsheltered population is thus likely to have declined even 
...
``Persons'' (P).\footnote{{\bf NB:} LAHSA counts unhoused TAY via a dedicated census. 
Our PIT teams identified such individuals, but their tally does not reflect LAHSA's
methodology. As such, all data in this document better reflect the adult unsheltered population 
as compared to that same quantity in 2020. Since only 6 TAY were sighted, combining them
with adults changes no results. We occasionally treat TAY as a standalone class 
for analytic purposes (Section \ref{sec:nulls}).}
...
\cmidrule{1-6}
{\bf All} & & & {\bf 74} & {\bf 1513} & {\bf 1358--1679}\\ 
\bottomrule
\end{tabular}
}
...
%In border tracts, this means nothing more than crossing the street. 
