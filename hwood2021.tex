...
\begin{figure*}[]
	...
	\caption{Compared to 2020, the 2021 PIT \Count\ identified 7 tracts with significantly more
			persons/dwellings, 14 with fewer (grey). Similar numbers hold for the total unsheltered 
			population (pink; parentheses denote 1\,$\sigma$-significant changes). 
			Professional-counted tracts are denoted by circles 
			(1 increase; 3 declines). Net, we identified about 200 fewer persons+structures or unsheltered 
...
from backing-out tract-level CVRTM counts from total populations and person counts provided
