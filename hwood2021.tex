...
unsheltered homelessness has fallen by $9\%\pm9\%$ and $15\%\pm12\%$, \resp, in those communities
...
has worsened over the past year. Given COVID-related disruptions to health, hygiene, 
...
1919.02$^{\rm c}$  & Hollywood & Vol & 1 & 21 & 10--32 \\
...
\cmidrule{1-6}
{\bf All} & & & {\bf 73} & {\bf 1475} & {\bf 1372--1581}\\ 
\bottomrule
\end{tabular}
}
\caption*{$^{\rm a}$Volunteer vs.~professional surveyor; $^{\rm b}$no.~teams deployed to 
		tract; $^{\rm c}$ surveyed 16 March; $^{\rm d}$one tally rejected during quality control.}
...
Inhabitants & 282 (28) & 2 (3) & 32 (11) & 54 (14) & 56 (14) & 339 (29) & 195 (24) & {\bf 937 (93)} & {\bf 1058} & $\bf -9\%\,(9\%)$\\% {\bf 1058}(76)
...
comprising the Hollywood Community.\footnote{\bfr Forgot 1919.02...} Modulated by the baseline CVRTM weights, these 
...
those levels. Using the PDFs' medians and 90\% CIs, we infer declines of $9\%\pm9\%$ and 
$15\%\pm12\%$, \resp. 
...
decline in unsheltered people from 98\% to 88\%. %98\% to 92\%. 
...
\caption*{$^{\rm a}$Omitted in PIT; surveyed 6:00 AM 16 March. Estimates reflect PDF medians with 90\% CIs shown in parentheses.}
\label{tbl:allPop}
\end{table*}
